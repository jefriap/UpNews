...
package com.upnews.app.sync.workers
...
import com.upnews.app.sync.initializers.SyncConstraints
import com.upnews.app.sync.initializers.syncForegroundInfo
import com.upnews.app.sync.status.SyncSubscriber
...
class SyncWorker @AssistedInject constructor(
    ...
    private val UpNewsPreferences: UpNewsPreferencesDataSource,
    ...
    override suspend fun getChangeListVersions(): ChangeListVersions =
        UpNewsPreferences.getChangeListVersions()

    override suspend fun updateChangeListVersions(
        update: ChangeListVersions.() -> ChangeListVersions,
    ) = UpNewsPreferences.updateChangeListVersion(update)
