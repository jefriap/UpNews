...
fun UpNewsViewToggleButton(
    ...
    TextButton(
        ...
        contentPadding = UpNewsViewToggleDefaults.ViewToggleButtonContentPadding,
    ) {
        UpNewsViewToggleButtonContent(
            text = if (expanded) expandedText else compactText,
            trailingIcon = {
                Icon(
                    imageVector = if (expanded) UpNewsIcons.ViewDay else UpNewsIcons.ShortText,
 ...
 */
@Composable
private fun UpNewsViewToggleButtonContent(
 ...
 */
object UpNewsViewToggleDefaults {
    // TODO: File bug
