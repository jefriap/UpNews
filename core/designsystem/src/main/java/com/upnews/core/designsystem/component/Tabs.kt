    ...
    Tab(
        ...
        text = {
            ...
            ProvideTextStyle(
                value = style,
                content = {
                    Box(modifier = Modifier.padding(top = UpNewsTabDefaults.TabTopPadding)) {
                        text()
                    }
                },
            )
 ...
 * @param tabs The tabs inside this tab row. Typically this will be multiple [UpNewsTab]s. Each element
