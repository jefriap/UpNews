...
import com.upnews.core.data.model.topicCrossReferences
import com.upnews.core.data.model.topicEntityShells
import com.upnews.core.database.dao.NewsResourceDao
import com.upnews.core.database.dao.TopicDao
import com.upnews.core.database.model.PopulatedNewsResource
...
import com.upnews.core.notifications.Notifier
    ...
    override suspend fun syncWith(synchronizer: Synchronizer): Boolean {
        ...
        return synchronizer.changeListSync(
            ...
            modelUpdater = { changedIds ->
                val userData = upnewsPreferencesDataSource.userData.first()
                ...
                if (isFirstSync) {
                    ...
                    upnewsPreferencesDataSource.setNewsResourcesViewed(changedIds, true)
                }
